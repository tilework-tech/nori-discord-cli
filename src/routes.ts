...
export const KNOWN_ROUTES: KnownRoute[] = [
  {
    ...
    docs_url: 'https://docs.discord.com/developers/resources/user#get-current-user',
  },
  {
    method: 'GET',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/guild#get-guild',
  },
  {
    method: 'GET',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/guild#get-guild-channels',
  },
  {
    method: 'POST',
    path: '/guilds/{guild_id}/channels',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/guild#create-guild-channel',
  },
  {
    method: 'GET',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/channel#get-channel',
  },
  {
    method: 'GET',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#get-channel-messages',
  },
  {
    method: 'GET',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#get-channel-message',
  },
  {
    method: 'POST',
    path: '/channels/{channel_id}/messages',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#create-message',
  },
  {
    method: 'PATCH',
    path: '/channels/{channel_id}/messages/{message_id}',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#edit-message',
  },
  {
    method: 'DELETE',
    path: '/channels/{channel_id}/messages/{message_id}',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#delete-message',
  },
  {
    method: 'PUT',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/message#create-reaction',
  },
  {
    method: 'POST',
    ...
    docs_url: 'https://docs.discord.com/developers/resources/webhook#execute-webhook',
  },
];
